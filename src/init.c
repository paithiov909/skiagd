...
SEXP savvy_sk_draw_circle__impl(SEXP c_arg__size, SEXP c_arg__curr_bytes, SEXP c_arg__mat, SEXP c_arg__props, SEXP c_arg__x, SEXP c_arg__y, SEXP c_arg__radius, SEXP c_arg__width, SEXP c_arg__color) {
    SEXP res = savvy_sk_draw_circle__ffi(c_arg__size, c_arg__curr_bytes, c_arg__mat, c_arg__props, c_arg__x, c_arg__y, c_arg__radius, c_arg__width, c_arg__color);
    return handle_result(res);
}

SEXP savvy_sk_draw_diff_rect__impl(SEXP c_arg__size, SEXP c_arg__curr_bytes, SEXP c_arg__mat, SEXP c_arg__props, SEXP c_arg__outer_xywh, SEXP c_arg__outer_rx, SEXP c_arg__outer_ry, SEXP c_arg__inner_xywh, SEXP c_arg__inner_rx, SEXP c_arg__inner_ry, SEXP c_arg__width, SEXP c_arg__color) {
    SEXP res = savvy_sk_draw_diff_rect__ffi(c_arg__size, c_arg__curr_bytes, c_arg__mat, c_arg__props, c_arg__outer_xywh, c_arg__outer_rx, c_arg__outer_ry, c_arg__inner_xywh, c_arg__inner_rx, c_arg__inner_ry, c_arg__width, c_arg__color);
    return handle_result(res);
}

SEXP savvy_sk_draw_line__impl(SEXP c_arg__size, SEXP c_arg__curr_bytes, SEXP c_arg__mat, SEXP c_arg__props, SEXP c_arg__from_x, SEXP c_arg__from_y, SEXP c_arg__to_x, SEXP c_arg__to_y, SEXP c_arg__width, SEXP c_arg__color) {
    SEXP res = savvy_sk_draw_line__ffi(c_arg__size, c_arg__curr_bytes, c_arg__mat, c_arg__props, c_arg__from_x, c_arg__from_y, c_arg__to_x, c_arg__to_y, c_arg__width, c_arg__color);
    return handle_result(res);
}
...
SEXP savvy_sk_draw_rounded_rect__impl(SEXP c_arg__size, SEXP c_arg__curr_bytes, SEXP c_arg__mat, SEXP c_arg__props, SEXP c_arg__xywh, SEXP c_arg__rx, SEXP c_arg__ry, SEXP c_arg__width, SEXP c_arg__color) {
    SEXP res = savvy_sk_draw_rounded_rect__ffi(c_arg__size, c_arg__curr_bytes, c_arg__mat, c_arg__props, c_arg__xywh, c_arg__rx, c_arg__ry, c_arg__width, c_arg__color);
    return handle_result(res);
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"savvy_sk_draw_diff_rect__impl", (DL_FUNC) &savvy_sk_draw_diff_rect__impl, 12},
    ...
    {"savvy_sk_draw_rounded_rect__impl", (DL_FUNC) &savvy_sk_draw_rounded_rect__impl, 9},
