...
The following is a simple example of animation using [mp4encoder](https://github.com/coolbutuseless/mp4encoder), converted to gif for display.
...
Since the original [R Logo](https://www.r-project.org/logo/) is copyrighted by **2016 The R Foundation** and licensed under the [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/), this animation is licensed under the same license.
