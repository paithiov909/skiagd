...
1. **Create a canvas** with a background colour. The call `canvas()` returns a new [picture](https://paithiov909.r-universe.dev/skiagd/doc/manual.html#pictures) object that represents the drawing state.
