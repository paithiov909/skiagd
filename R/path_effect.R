...
#' You can apply a path effect to paintings via [paint()].
...
#' @param seed A integer scalar; random seed.
...
#' @param path A character vector of SVG notation to replicate.
#' @param advance A numeric scalar; space between instances of path.
#' @param style A character scalar; how to transform path at each point.
#' Can be `"translate"`, `"rotate"`, or `"morph"`.
#' @param mat A numeric vector; transformation matrix.
